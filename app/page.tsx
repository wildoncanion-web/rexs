    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main>
        ...
        <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-3"><div className="rounded-xl border border-border bg-card p-6"><BarChart3 className="size-6 text-primary" /><h3 className="mt-10 text-xl font-semibold">Performance, in context</h3><p className="mt-3 leading-7 text-muted-foreground">Track returns against your goals with clear time ranges and practical portfolio insights.</p></div><div className="rounded-xl border border-border bg-card p-6"><CircleDollarSign className="size-6 text-primary" /><h3 className="mt-10 text-xl font-semibold">One consolidated view</h3><p className="mt-3 leading-7 text-muted-foreground">Keep equities, fixed income, cash, and international exposure organized in one place.</p></div><div className="rounded-xl border border-border bg-card p-6"><ShieldCheck className="size-6 text-primary" /><h3 className="mt-10 text-xl font-semibold">Designed for trust</h3><p className="mt-3 leading-7 text-muted-foreground">Your account experience is built around secure access and transparent reporting.</p></div></div>
        </section>
